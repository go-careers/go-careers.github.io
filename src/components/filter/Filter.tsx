...
const Filter = (_props: FilterProps) => {
  return (
    <div className="job">
   ...
   Milao
    ...
    Londontowne, MD
          ...
          <div className="search-salary">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" fill="currentColor" strokeWidth=".4">
       ...
       The User Experience Designer position exists to create compelling and digital user experience through excellent design...
           ...
           2972 Westheimer Rd. Santa Ana.
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="heart feather feather-heart">
